...
- Видео-креативы анализируются по постеру (кадру-превью видео); само видео в OpenAI не отправляется. Если у видео нет постера и других картинок — объявление пропускается с записью в лог.
